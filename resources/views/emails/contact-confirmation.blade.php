...
<style>
  ...
  .summary-label { font-size: 10px; text-transform: uppercase; letter-spacing: .15em; font-weight: 700; color: #991b1b; margin-bottom: 10px; }
  .summary-row { display: flex; gap: 12px; margin-bottom: 6px; }
  .summary-key { font-size: 12px; font-weight: 700; color: #6b7280; min-width: 70px; }
  .summary-val { font-size: 13px; color: #111827; }
...
<div class="card">
  ...
  <div class="body">
    ...
    <div class="message">
      Thank you for reaching out to us. We have received your message and our team will get back to you
    ...
    <div class="summary-box">
      ...
      <div class="summary-row">
        ...
        <span class="summary-val">{{ $data['subject'] }}</span>
      </div>
      <div class="summary-row">
        <span class="summary-key">Sent</span>
        <span class="summary-val">{{ now()->format('F j, Y · g:i A') }}</span>
      </div>
      @if(!empty($data['company']))
      <div class="summary-row">
        <span class="summary-key">Company</span>
        <span class="summary-val">{{ $data['company'] }}</span>
      </div>
      @endif
    </div>

    <div class="message">
      While you wait, feel free to reach us directly if your need is urgent:
    </div>
