...
<div x-data="{
  ...
  <div class="container mx-auto px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
...
<!-- ================================================================
     ABOUT
================================================================ -->
<section id="about" class="py-12 sm:py-20 lg:py-28 bg-white">
  <div class="container mx-auto px-4 sm:px-6">
    <div class="grid lg:grid-cols-12 gap-8 lg:gap-16 items-center">
      ...
      <div class="lg:col-span-6 reveal">
        ...
        <h2 class="font-display text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] leading-none text-gray-900">
        ...
        <div class="mt-8 grid grid-cols-2 gap-4">
          <div class="border-l-2 border-red-800 pl-4">
            <div class="font-display text-2xl sm:text-3xl text-gray-900">30<span class="text-red-800">+</span></div>
            <div class="text-xs tracking-widest uppercase text-gray-500 mt-1">Years in Business</div>
          </div>
          <div class="border-l-2 border-red-800 pl-4">
            <div class="font-display text-2xl sm:text-3xl text-gray-900">Nationwide</div>
            <div class="text-xs tracking-widest uppercase text-gray-500 mt-1">Delivery Coverage</div>
          </div>
          <div class="border-l-2 border-red-800 pl-4">
            <div class="font-display text-2xl sm:text-3xl text-gray-900">500<span class="text-red-800">+</span></div>
            <div class="text-xs tracking-widest uppercase text-gray-500 mt-1">Projects Completed</div>
          </div>
          <div class="border-l-2 border-red-800 pl-4">
            <div class="font-display text-2xl sm:text-3xl text-gray-900">100<span class="text-red-800">%</span></div>
...
<section id="products" class="py-12 sm:py-20 lg:py-28 bg-gray-50"
  ...
  <div class="container mx-auto px-4 sm:px-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5 reveal">
...
<section id="gallery" class="py-12 sm:py-20 lg:py-28 bg-gray-900 text-white"
  x-data="{
    open: false,
    idx: 0,
    images: {{ $galleryJson }},
...
<!-- ================================================================
     SERVICES
================================================================ -->
<section id="services" class="py-12 sm:py-20 lg:py-28 bg-white">
  <div class="container mx-auto px-4 sm:px-6">
    ...
    <div class="grid lg:grid-cols-2 gap-8 lg:gap-20 items-start">
      ...
      <div class="grid sm:grid-cols-2 gap-5 reveal">
        ...
        <div class="group border border-gray-200 hover:border-red-800 p-6 transition-all duration-200 hover:shadow-md">
          <div class="font-display text-3xl sm:text-4xl text-gray-100 group-hover:text-red-100 leading-none mb-3 transition-colors">
            {{ $svc['num'] }}
          </div>
...
<!-- ================================================================
     WHY CHOOSE US
================================================================ -->
<section id="why-us" class="py-12 sm:py-20 lg:py-28 bg-gray-900 text-white relative overflow-hidden">
  {{-- Background accent --}}
  ...
  <div class="container mx-auto px-4 sm:px-6 relative">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 reveal">
      ...
      @foreach($whys as $why)
      <div class="group border border-white/10 hover:border-red-600 bg-white/5 hover:bg-white/10 p-5 sm:p-7 transition-all duration-200">
        ...
        <div class="font-display text-xl sm:text-2xl text-white mb-2">{{ $why['title'] }}</div>
...
================================================================ -->
<section class="py-10 sm:py-16 md:py-20 bg-white border-t border-gray-100">
  <div class="container mx-auto px-4 sm:px-6">
    <div class="text-center mb-8 sm:mb-12 reveal">
      ...
      <h2 class="font-display text-3xl sm:text-4xl md:text-5xl leading-none text-gray-900">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-5 reveal">
      ...
      @endphp
      @foreach($certs as $c)
      <div class="flex flex-col items-center text-center p-3 sm:p-6 border-2 border-gray-100 hover:border-red-200 hover:shadow-md transition-all group">
...
<!-- ================================================================
     TESTIMONIALS
================================================================ -->
<section class="py-12 sm:py-20 lg:py-28 bg-gray-50">
  <div class="container mx-auto px-4 sm:px-6">
    <div class="text-center mb-8 sm:mb-14 reveal">
      <div class="flex items-center justify-center gap-3 mb-4">
        <div class="h-px w-10 bg-red-800"></div>
    ...
    <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-5 reveal">
      @php
      $testimonials = [
        [
...
================================================================ -->
<section id="coverage" class="py-12 sm:py-20 lg:py-28 bg-gray-900 text-white relative overflow-hidden">
  <div class="absolute inset-0 opacity-5 pointer-events-none"
       style="background-image:repeating-linear-gradient(0deg,transparent,transparent 39px,#fff 39px,#fff 40px),repeating-linear-gradient(90deg,transparent,transparent 39px,#fff 39px,#fff 40px);"></div>
  <div class="container mx-auto px-4 sm:px-6 relative">
    <div class="text-center mb-8 sm:mb-14 reveal">
    ...
    <div class="grid lg:grid-cols-2 gap-8 lg:gap-14 items-center reveal">
      ...
      <div class="space-y-6">
        ...
        <div class="border border-white/10 hover:border-white/25 p-4 sm:p-5 transition-colors group">
...
================================================================ -->
<section id="estimator" class="py-12 sm:py-20 lg:py-28 bg-white">
  <div class="container mx-auto px-4 sm:px-6">
...
<!-- ================================================================
     FAQ ACCORDION
================================================================ -->
<section id="faq" class="py-12 sm:py-20 lg:py-28 bg-gray-50">
  <div class="container mx-auto px-4 sm:px-6">
    <div class="max-w-3xl mx-auto">
      <div class="text-center mb-8 sm:mb-12 reveal">
        <div class="flex items-center justify-center gap-3 mb-4">
...
================================================================ -->
<section id="contact" class="py-12 sm:py-20 lg:py-28 bg-white">
  <div class="container mx-auto px-4 sm:px-6">
    ...
    <div class="grid lg:grid-cols-2 gap-8 lg:gap-14 reveal">
      ...
      <div>
        ...
        <div class="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 pt-8 border-t border-gray-200">
          ...
          <div>
            ...
            <div class="text-sm font-medium text-gray-900">Mon–Fri · 9AM–5PM</div>
          </div>
        </div>
      </div>
...
<!-- ================================================================
     INQUIRE / GET A QUOTE
================================================================ -->
<section id="inquire" class="py-12 sm:py-20 lg:py-28 bg-gray-50">
  <div class="container mx-auto px-4 sm:px-6">
...
<!-- ================================================================
     FACEBOOK FEED
================================================================ -->
<section class="py-12 sm:py-20 lg:py-24 bg-gray-50 border-t border-gray-200">
  <div class="container mx-auto px-4 sm:px-6">
...
<footer class="bg-gray-950 text-white">
  <div class="container mx-auto px-4 sm:px-6 pt-10 sm:pt-14 pb-8">
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 mb-10 sm:mb-12">
      ...
      <div>
        ...
        <ul class="space-y-2">
          <li><a href="#products" class="text-sm text-gray-400 hover:text-white transition-colors">I-Beam / H-Beam</a></li>
          <li><a href="#products" class="text-sm text-gray-400 hover:text-white transition-colors">Wide Flange</a></li>
          <li><a href="#products" class="text-sm text-gray-400 hover:text-white transition-colors">T-Beam</a></li>
          <li><a href="#products" class="text-sm text-gray-400 hover:text-white transition-colors">MS Plate</a></li>
          <li><a href="#products" class="text-sm text-gray-400 hover:text-white transition-colors">Sheet Pile / Z Type</a></li>
          <li><a href="#products" class="text-sm text-gray-400 hover:text-white transition-colors">Steel Tubular B.I / G.I</a></li>
          <li><a href="#products" class="text-sm text-gray-400 hover:text-white transition-colors">Steel Pipe B.I / G.I</a></li>
          <li class="pt-1 border-t border-white/10"><a href="#products" class="text-sm text-gray-400 hover:text-white transition-colors">C-Channel / Channel Bar</a></li>
          <li><a href="#products" class="text-sm text-gray-400 hover:text-white transition-colors">Anchor Bolt</a></li>
          <li><a href="#products" class="text-sm text-gray-400 hover:text-white transition-colors">Deformed Bar</a></li>
          <li><a href="#products" class="text-sm text-gray-400 hover:text-white transition-colors">Plain Round Bar</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-4">
          ...
          <li class="flex items-start gap-3">
            ...
            <span class="text-sm text-gray-400">Mon–Fri · 9AM–5PM</span>
          </li>
        </ul>
      </div>
    </div>
